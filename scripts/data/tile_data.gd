...
const boost_cap_text = "and a capital boost of +{cap_linked} from these points: {cap_list}\n"
...
func get_info() -> String:
	...
	if type == 0:
		...
		return ("{0}, {1}\n".format([coords,move_to_value_comp])+enemy_compile+attack_copile+boost_text+boost_compile+reach_compile)
	elif type == 2:
